...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:run
:: update PATH to active version
set "path=%bindir%;%bindir%\Scripts;%path%"

:: copy params to program precisely, preserving double-quotes and percents.
:: this is the main fix for how 'exec' processing in pyenv.vbs did not
:: correctly handle (get passed) params with percent chars in them
set "params="
:paramloop
if not [%2]==[] (
  set "params=%params% %2"
